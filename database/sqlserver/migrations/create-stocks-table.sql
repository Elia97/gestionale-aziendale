...
EXECUTE sp_addextendedproperty 
    N'MS_Description', N'ID del prodotto collegato',
    N'schema', N'dbo',
    N'table', N'stocks',
    N'column', N'product_id';

EXECUTE sp_addextendedproperty 
    N'MS_Description', N'ID del magazzino collegato',
    N'schema', N'dbo',
    N'table', N'stocks',
    N'column', N'warehouse_id';

EXECUTE sp_addextendedproperty 
    N'MS_Description', N'Quantità disponibile del prodotto nel magazzino',
    N'schema', N'dbo',
    N'table', N'stocks',
    N'column', N'quantity';
