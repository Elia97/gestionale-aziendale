...
EXECUTE sp_addextendedproperty 
    N'MS_Description', N'ID del cliente che ha effettuato l''ordine',
    N'schema', N'dbo',
    N'table', N'orders',
    N'column', N'customer_id';

EXECUTE sp_addextendedproperty 
    N'MS_Description', N'ID dell''utente che ha gestito l''ordine',
    N'schema', N'dbo',
    N'table', N'orders',
    N'column', N'user_id';

EXECUTE sp_addextendedproperty 
    N'MS_Description', N'Stato dell''ordine (default ''pending'')',
    N'schema', N'dbo',
    N'table', N'orders',
    N'column', N'status';

EXECUTE sp_addextendedproperty 
    N'MS_Description', N'Totale complessivo dell''ordine',
    N'schema', N'dbo',
    N'table', N'orders',
    N'column', N'total';
