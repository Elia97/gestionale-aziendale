...
CREATE TABLE dbo.products (
    ...
    CONSTRAINT chk_products_category CHECK (category IN ('informatica', 'accessori', 'monitor', 'storage', 'networking', 'audio'))
);

-- Commento alla tabella
EXECUTE sp_addextendedproperty 
    N'MS_Description', N'Codice unico prodotto',
    N'schema', N'dbo',
    N'table', N'products',
    N'column', N'code';
...
EXECUTE sp_addextendedproperty 
    N'MS_Description', N'Nome del prodotto',
    N'schema', N'dbo',
    N'table', N'products',
    N'column', N'name';

EXECUTE sp_addextendedproperty 
    N'MS_Description', N'Descrizione del prodotto (opzionale)',
    N'schema', N'dbo',
    N'table', N'products',
    N'column', N'description';

EXECUTE sp_addextendedproperty 
    N'MS_Description', N'Prezzo del prodotto',
    N'schema', N'dbo',
    N'table', N'products',
    N'column', N'price';

EXECUTE sp_addextendedproperty 
    N'MS_Description', N'Categoria prodotto (default "informatica")',
    N'schema', N'dbo',
    N'table', N'products',
    N'column', N'category';
