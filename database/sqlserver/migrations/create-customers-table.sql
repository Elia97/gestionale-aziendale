...
EXECUTE sp_addextendedproperty 
    N'MS_Description', N'Nome del cliente',
    N'schema', N'dbo',
    N'table', N'customers',
    N'column', N'name';
...
EXECUTE sp_addextendedproperty 
    N'MS_Description', N'Email unica del cliente',
    N'schema', N'dbo',
    N'table', N'customers',
    N'column', N'email';

EXECUTE sp_addextendedproperty 
    N'MS_Description', N'Telefono del cliente (opzionale)',
    N'schema', N'dbo',
    N'table', N'customers',
    N'column', N'phone';

EXECUTE sp_addextendedproperty 
    N'MS_Description', N'Indirizzo del cliente (opzionale)',
    N'schema', N'dbo',
    N'table', N'customers',
    N'column', N'address';
