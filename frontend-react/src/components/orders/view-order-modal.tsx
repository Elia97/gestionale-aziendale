...
/**
 * Componente per visualizzare i dettagli di un ordine in una modale.
 * Mostra informazioni come cliente, stato, data, prodotti ordinati e totale.
 * Gestisce la visualizzazione mobile e desktop in base alla larghezza dello schermo.
 * @param isViewModalOpen - Indica se la modale è aperta.
 * @param setIsViewModalOpen - Funzione per chiudere la modale.
 * @param selectedOrder - Ordine selezionato da visualizzare.
 */
        ...
        {selectedOrder && (
          <div className="space-y-4 overflow-y-auto flex-1 pr-2 -mr-2">
            ...
            <div>
              ...
              <div className="mt-2">{renderOrderItems()}</div>
            </div>

            <div className="flex justify-end pt-4 border-t">
              <div className="text-right">
                <div className="text-lg font-bold">
                  Totale Ordine: {formatCurrency(Number(selectedOrder.total))}
                </div>
                <div className="text-sm text-muted-foreground">
                  {selectedOrder.order_items.length} articoli
                </div>
              </div>
            </div>
          </div>
