...
/**
 * Componente per la visualizzazione della tabella dei magazzini.
 * Gestisce la visualizzazione mobile e desktop in base alla larghezza dello schermo.
 * @param filteredWarehouses - Lista dei magazzini filtrati da visualizzare.
 * @param searchTerm - Termine di ricerca corrente.
 * @param handleEditWarehouse - Funzione per gestire la modifica di un magazzino.
 * @param handleDeleteWarehouse - Funzione per gestire l'eliminazione di un magazzino.
 * @param handleManageStock - Funzione per gestire lo stock di un magazzino.
 * @param handleViewWarehouse - Funzione per visualizzare i dettagli di un magazzino.
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="grid grid-cols-2 gap-1 w-full sm:flex sm:gap-2 sm:justify-end">
                      ...
                      <Button
                        variant="ghost"
                        size="sm"
                        onClick={() => handleManageStock(warehouse)}
                        className="sm:flex-none"
                      >
