...
/**
 * Componente per la visualizzazione della tabella dei prodotti.
 * Gestisce la visualizzazione mobile e desktop in base alla larghezza dello schermo.
 * @param filteredProducts - Lista dei prodotti filtrati da visualizzare.
 * @param searchTerm - Termine di ricerca corrente.
 * @param categoryFilter - Categoria corrente del filtro dei prodotti.
 * @param handleEditProduct - Funzione per gestire la modifica di un prodotto.
 * @param handleDeleteProduct - Funzione per gestire l'eliminazione di un prodotto.
 * @param getTotalStock - Funzione per calcolare lo stock totale di un prodotto.
 */
                ...
                <TableRow key={product.id}>
                  ...
                  <TableCell>
                    <div className="flex items-center gap-2">
                      <div
                        className={`bg-destructive/10 text-destructive rounded px-2 py-1 text-xs font-medium ${
                          isLowStock
