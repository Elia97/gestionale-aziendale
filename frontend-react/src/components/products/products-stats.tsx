...
/**
 * Componente per visualizzare le statistiche dei prodotti.
 * Mostra il numero totale di prodotti, valore del magazzino, scorte totali e scorte basse.
 * @param stats - Oggetto contenente le statistiche dei prodotti.
 */
