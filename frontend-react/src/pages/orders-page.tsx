 ...
 * Include intestazione, statistiche, filtri e tabella degli ordini.
 * Gestisce l'aggiunta, modifica, visualizzazione e cancellazione degli ordini tramite modali e dialoghi.
 * @returns Componente React che rappresenta la pagina degli ordini.
 */
