...
/**
 * Pagina principale per la gestione dei prodotti.
 * Include intestazione, statistiche, filtri e tabella dei prodotti.
 * Gestisce l'aggiunta, modifica e cancellazione dei prodotti tramite modali e dialoghi.
 * @returns Componente React che rappresenta la pagina dei prodotti.
 */
export default function ProductsPage(): React.JSX.Element {
  ...
  return (
    <div className="space-y-6">
      <ProductsHeader handleAddProduct={productsLogic.handleAddProduct} />
      <ProductsStats stats={productsLogic.stats} />
      <ProductsFilters
