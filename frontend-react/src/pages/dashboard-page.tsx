 ...
 * Mostra statistiche generali, ordini recenti e avvisi di scorte basse.
 * Utilizza hook personalizzati per la logica del dashboard.
 * @returns Componente React che rappresenta la pagina del dashboard.
 */
