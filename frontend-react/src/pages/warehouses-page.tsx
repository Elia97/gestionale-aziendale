...
/**
 * Pagina principale per la gestione dei magazzini.
 * Include intestazione, statistiche, filtri e tabella dei magazzini.
 * Gestisce l'aggiunta, modifica, visualizzazione e cancellazione dei magazzini tramite modali e dialoghi.
 * @returns Componente React che rappresenta la pagina dei magazzini.
 */
export default function WarehousesPage(): React.JSX.Element {
  ...
  return (
    <div className="space-y-6">
      ...
      />
      <WarehousesStats stats={warehousesLogic.stats} />
      <WarehousesFilters
